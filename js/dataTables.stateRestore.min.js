...
(a?h(a):this.context[0]._stateRestore.removeAll(h));return this});b("stateRestore.activeStates()",function(){var a=this.context[0];this.length=0;if(!a._stateRestore){var e=p.fn.DataTable.Api(a),h=new p.fn.dataTable.StateRestoreCollection(e,{});g(e,h)}a._stateRestore&&this.push.apply(this,a._stateRestore.findActive());return this});p.fn.dataTable.ext.buttons.stateRestore={action:function(a,e,h,q){q._stateRestore.load();h.blur()},config:{split:["updateState","renameState","removeState"]},text:function(a){return a.i18n("buttons.stateRestore",
"State %d",a.stateRestore.states()[0].length+1)}};p.fn.dataTable.ext.buttons.updateState={action:function(a,e,h,q){p("div.dt-button-background").click();q.parent._stateRestore.save()},text:function(a){return a.i18n("buttons.updateState","Update")}};p.fn.dataTable.ext.buttons.savedStates={buttons:[],extend:"collection",init:function(a,e,h){a.on("stateRestore-change",function(){a.button(e).text(a.i18n("buttons.savedStates","Saved States",a.stateRestore.states().length))});void 0===a.settings()[0]._stateRestore&&
...
"Create State")}};p.fn.dataTable.ext.buttons.removeState={action:function(a,e,h,q){q.parent._stateRestore.remove();h.blur()},text:function(a){return a.i18n("buttons.removeState","Remove")}};p.fn.dataTable.ext.buttons.removeAllStates={action:function(a,e,h){e.stateRestore.states().remove(!0);h.blur()},className:"dt-button dtsr-removeAllStates",init:function(a,e){a.settings()[0]._stateRestore&&0!==a.stateRestore.states().length||p(e).addClass("disabled")},text:function(a){return a.i18n("buttons.removeAllStates",
"Remove All States")}};p.fn.dataTable.ext.buttons.renameState={action:function(a,e,h,q){a=[];var k=0;for(e=e.settings()[0]._stateRestore.s.states;k<e.length;k++)a.push(e[k].s.identifier);q.parent._stateRestore.rename(void 0,a);h.blur()},text:function(a){return a.i18n("buttons.renameState","Rename")}};p(d).on("preInit.dt.dtsr",function(a,e){"dt"!==a.namespace||!e.oInit.stateRestore&&!m.defaults.stateRestore||e._stateRestore||(a=null,void 0===a&&(a=null),e=new m.Api(e),a=a?a:e.init().stateRestore||
m.defaults.stateRestore,a=new C(e,a),g(e,a))})})})();
